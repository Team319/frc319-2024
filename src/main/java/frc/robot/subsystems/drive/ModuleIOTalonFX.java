    ...
    switch (index) {
      case 0: // FL
        ...
        switch (Constants.currentMode) {
          case REAL:
            absoluteEncoderOffset = new Rotation2d(0.733038); // MUST BE CALIBRATED
            break;
      ...
      case 1: // FR
        ...
        cancoder = new CANcoder(11, "Swerve Canivore");
         switch (Constants.currentMode) {
          case REAL:
            absoluteEncoderOffset = new Rotation2d(1.74533); // MUST BE CALIBRATED
            break;
      ...
      case 2: // BL
        ...
        cancoder = new CANcoder(5, "Swerve Canivore");
         switch (Constants.currentMode) {
          case REAL:
            absoluteEncoderOffset = new Rotation2d(-0.261799); // MUST BE CALIBRATED
            break;
      ...
      case 3: // BR
        ...
        switch (Constants.currentMode) {
          case REAL:
            absoluteEncoderOffset = new Rotation2d(1.0472); // MUST BE CALIBRATED
            break;
